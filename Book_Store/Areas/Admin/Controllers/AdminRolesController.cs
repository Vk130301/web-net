    ...
    public class AdminRolesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Roles != null ? 
                          ...
                          Problem("Entity set 'QlBansachContext.Roles'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("RoleId,RoleName,Description")] Role role)
        {
            if (ModelState.IsValid)
            {
                ...
                _toastNotification.AddSuccessToastMessage("Tạo quyền truy cập thành công");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'QlBansachContext.Roles'  is null.");
            }
            var role = await _context.Roles.FindAsync(id);
            var table = _context.Roles.Include(t => t.Accounts).FirstOrDefault(t => t.RoleId == id);
            foreach (var item in table.Accounts)
            {
            ...
            await _context.SaveChangesAsync();
			_toastNotification.AddSuccessToastMessage("Xóa quyền truy cập thành công");
			return RedirectToAction(nameof(Index));
        }
